...
@implementation RBNetworkConfig {
    NSMutableArray<id<RBUrlFilterProtocol>> *_urlFilters;
    NSMutableArray<id<RBCacheDirPathFilterProtocol>> *_cacheDirPathFilters;
}
...
- (NSArray<id<RBUrlFilterProtocol>> *)urlFilters {
    return [_urlFilters copy];
}

- (NSArray<id<RBCacheDirPathFilterProtocol>> *)cacheDirPathFilters {
